...
function getBiquadFilter(context, options) {
  ...
  lowpass.frequency.value = (options == null ? void 0 : options.frequencyValue) ?? frequencyValue;
  lowpass.Q.value = (options == null ? void 0 : options.qualityValue) ?? qualityValue;
  return lowpass;
}
