 ...
 * @group Functions
 */
export declare function createRealtimeBpmAnalyzer(audioContext: AudioContext, processorOptions?: RealTimeBpmAnalyzerParameters): Promise<BpmAnalyzer>;
/**
 * @deprecated Use {@link createRealtimeBpmAnalyzer} instead, will be removed in next major release
 * @hidden
 */
export declare const createRealTimeBpmProcessor: typeof createRealtimeBpmAnalyzer;
